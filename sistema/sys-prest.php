...
$sql = "SELECT * FROM servicos_prestadores where FK_id_prestador = $id ORDER BY id_serv DESC";
...
<body>
    ...
    <section id="perfil">
        ...
        <div class="perfil_text">
            ...
            while ($user_data = mysqli_fetch_assoc($result)) {
                ...
                echo '<br>';
                echo '<div>';
                echo "<a class='editar_perfil' href='edt-prest.php?id=$user_data[id]'>Editar perfil</a>";
    ...
    <section>
        ...
        <div class="servicos">
            ...
            <div class="servicos_block">
                <img src='../assets/sitioexemplo.jpg' width='100px'>

                <p>Nome serviços</p>
                <p>Dias disponiveis</p>
                <p>Nome serviços</p>
                <p>Nome serviços</p>
                <a class="editar_perfil">Editar</a>
                <a class="excluir_perfil">Excluir</a>
            </div>
            <div class="servicos_block">
                <img src='../assets/sitioexemplo.jpg' width='100px'>
