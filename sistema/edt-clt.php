...
if (!empty($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        header('Location: ../servicos/meus-pedidos.php');
    }
} else {
    header('Location: ../servicos/meus-pedidos.php');
}
    ...
    <div class="box">
        ...
        <form action="savedt-clt.php" method="POST">
            <fieldset>
                ...
                <br>
                <input type="radio" id="outro" name="sexo" value="outro" <?php echo ($sexo == "outro") ? "checked" : "" ?>
                    required>
